 ...
 * Returns null when the model isn't in the table OR when token counts
 * are absent. Caller persists null without warning — pricing gaps
 * surface in the eval dashboard as "model X has 0% costed calls"
