...
| R-09 | Call-recording retention gap: 90-day deletion of Twilio recordings is being implemented; until shipped, recordings can outlive the committed window | 2 | 2 | 4 | Mitigate: recordings are opt-in (`VOICE_RECORDING_ENABLED`, default off) limiting exposure; complete the retention job (Policy 07) | Open (in progress) |
