...
export interface NoteCreateResponse {
   ...
   */
  fields: { [key: string]: NoteCreateResponse.Fields };
   ...
   */
  relationships: { [key: string]: NoteCreateResponse.Relationships };
...
export interface NoteRetrieveResponse {
   ...
   * (e.g. `$name`, `$email`); custom attributes use their bare slug.
   */
  fields: { [key: string]: NoteRetrieveResponse.Fields };
   ...
   * prefixed with `$` (e.g. `$owner`, `$contact`).
   */
  relationships: { [key: string]: NoteRetrieveResponse.Relationships };
...
export interface NoteUpdateResponse {
   ...
   * (e.g. `$name`, `$email`); custom attributes use their bare slug.
   */
  fields: { [key: string]: NoteUpdateResponse.Fields };
   ...
   * prefixed with `$` (e.g. `$owner`, `$contact`).
   */
  relationships: { [key: string]: NoteUpdateResponse.Relationships };
