...
export interface ContactCreateResponse {
   ...
   */
  fields: { [key: string]: ContactCreateResponse.Fields };
   ...
   */
  relationships: { [key: string]: ContactCreateResponse.Relationships };
...
export interface ContactDefinitionsResponse {
   ...
   */
  fieldDefinitions: { [key: string]: ContactDefinitionsResponse.FieldDefinitions };
   ...
   */
  relationshipDefinitions: { [key: string]: ContactDefinitionsResponse.RelationshipDefinitions };
}

export namespace ContactDefinitionsResponse {
...
export interface ContactRetrieveResponse {
   ...
   * (e.g. `$name`, `$email`); custom attributes use their bare slug.
   */
  fields: { [key: string]: ContactRetrieveResponse.Fields };
   ...
   * prefixed with `$` (e.g. `$owner`, `$contact`).
   */
  relationships: { [key: string]: ContactRetrieveResponse.Relationships };
...
export interface ContactUpdateResponse {
   ...
   * (e.g. `$name`, `$email`); custom attributes use their bare slug.
   */
  fields: { [key: string]: ContactUpdateResponse.Fields };
   ...
   * prefixed with `$` (e.g. `$owner`, `$contact`).
   */
  relationships: { [key: string]: ContactUpdateResponse.Relationships };
...
export interface ContactCreateParams {
  ...
  fields: {
    [key: string]:
      ...
      | boolean
      | Array<string>
      | ContactCreateParams.Address
      | ContactCreateParams.FullName
      | null;
  };
...
export interface ContactUpdateParams {
  ...
  fields?: {
    [key: string]:
      ...
      | boolean
      | Array<string>
      | ContactUpdateParams.Address
      | ContactUpdateParams.FullName
      | null;
  };
   ...
   * `replace`.
   */
  relationships?: { [key: string]: ContactUpdateParams.Relationships };
}
