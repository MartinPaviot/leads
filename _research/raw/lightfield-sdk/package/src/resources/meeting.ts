...
export interface MeetingCreateResponse {
   ...
   */
  fields: { [key: string]: MeetingCreateResponse.Fields };
   ...
   */
  relationships: { [key: string]: MeetingCreateResponse.Relationships };
...
export interface MeetingRetrieveResponse {
   ...
   * (e.g. `$name`, `$email`); custom attributes use their bare slug.
   */
  fields: { [key: string]: MeetingRetrieveResponse.Fields };
   ...
   * prefixed with `$` (e.g. `$owner`, `$contact`).
   */
  relationships: { [key: string]: MeetingRetrieveResponse.Relationships };
...
export namespace MeetingRetrieveResponse {
  export interface Fields {
    /**
     * The field value, or null if unset.
     */
...
export interface MeetingUpdateResponse {
   ...
   * (e.g. `$name`, `$email`); custom attributes use their bare slug.
   */
  fields: { [key: string]: MeetingUpdateResponse.Fields };
   ...
   * prefixed with `$` (e.g. `$owner`, `$contact`).
   */
  relationships: { [key: string]: MeetingUpdateResponse.Relationships };
...
export namespace MeetingUpdateResponse {
  export interface Fields {
    /**
     * The field value, or null if unset.
     */
