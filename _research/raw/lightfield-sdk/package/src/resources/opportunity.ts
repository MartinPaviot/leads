 ...
 */
export class Opportunity extends APIResource {
  /**
  ...
  retrieve(id: string, options?: RequestOptions): APIPromise<OpportunityRetrieveResponse> {
    return this._client.get(path`/v1/opportunities/${id}`, options);
  }
  ...
  ): APIPromise<OpportunityUpdateResponse> {
    return this._client.post(path`/v1/opportunities/${id}`, { body, ...options });
  }
   ...
   */
  list(
    query: OpportunityListParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<OpportunityListResponse> {
...
export interface OpportunityCreateResponse {
   ...
   */
  fields: { [key: string]: OpportunityCreateResponse.Fields };
   ...
   */
  relationships: { [key: string]: OpportunityCreateResponse.Relationships };
...
export interface OpportunityDefinitionsResponse {
   ...
   */
  fieldDefinitions: { [key: string]: OpportunityDefinitionsResponse.FieldDefinitions };
   ...
   */
  relationshipDefinitions: { [key: string]: OpportunityDefinitionsResponse.RelationshipDefinitions };
}

export namespace OpportunityDefinitionsResponse {
...
export namespace OpportunityListResponse {
...
export interface OpportunityRetrieveResponse {
   ...
   * (e.g. `$name`, `$email`); custom attributes use their bare slug.
   */
  fields: { [key: string]: OpportunityRetrieveResponse.Fields };
   ...
   * prefixed with `$` (e.g. `$owner`, `$contact`).
   */
  relationships: { [key: string]: OpportunityRetrieveResponse.Relationships };
...
export namespace OpportunityRetrieveResponse {
  export interface Fields {
    /**
     * The field value, or null if unset.
     */
...
export interface OpportunityUpdateResponse {
   ...
   * (e.g. `$name`, `$email`); custom attributes use their bare slug.
   */
  fields: { [key: string]: OpportunityUpdateResponse.Fields };
   ...
   * prefixed with `$` (e.g. `$owner`, `$contact`).
   */
  relationships: { [key: string]: OpportunityUpdateResponse.Relationships };
...
export interface OpportunityCreateParams {
  ...
  fields: {
    [key: string]:
      ...
      | boolean
      | Array<string>
      | OpportunityCreateParams.Address
      | OpportunityCreateParams.FullName
      | null;
  };
...
export namespace OpportunityCreateParams {
  export interface Address {
    /**
     * City name.
     */
...
export interface OpportunityUpdateParams {
  ...
  fields?: {
    [key: string]:
      ...
      | boolean
      | Array<string>
      | OpportunityUpdateParams.Address
      | OpportunityUpdateParams.FullName
      | null;
  };
   ...
   * or `replace`.
   */
  relationships?: { [key: string]: OpportunityUpdateParams.Relationships };
}

export namespace OpportunityUpdateParams {
  export interface Address {
    /**
     * City name.
     */
...
export declare namespace Opportunity {
  export {
    type OpportunityCreateResponse as OpportunityCreateResponse,
    type OpportunityDefinitionsResponse as OpportunityDefinitionsResponse,
    type OpportunityListResponse as OpportunityListResponse,
    type OpportunityRetrieveResponse as OpportunityRetrieveResponse,
    type OpportunityUpdateResponse as OpportunityUpdateResponse,
    type OpportunityCreateParams as OpportunityCreateParams,
    type OpportunityUpdateParams as OpportunityUpdateParams,
    type OpportunityListParams as OpportunityListParams,
  };
}
