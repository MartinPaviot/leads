...
} from './resources/meeting';
import { Member, MemberListParams, MemberListResponse, MemberRetrieveResponse } from './resources/member';
import {
  Note,
  NoteCreateParams,
  NoteCreateResponse,
...
import { WorkflowRun, WorkflowRunStatusResponse } from './resources/workflow-run';
...
export class Lightfield {
   ...
   */
  constructor({ baseURL = readEnv('LIGHTFIELD_BASE_URL'), apiKey, ...opts }: ClientOptions) {
    if (apiKey === undefined) {
      throw new Errors.LightfieldError(
        "Missing required client option apiKey; you need to instantiate the Lightfield client with an apiKey option, like new Lightfield({ apiKey: 'My API Key' }).",
      );
    }
    ...
    this.timeout = options.timeout ?? Lightfield.DEFAULT_TIMEOUT /* 1 minute */;
  ...
  static Lightfield = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static LightfieldError = Errors.LightfieldError;
   ...
   */
  meeting: API.Meeting = new API.Meeting(this);
  /**
   ...
   */
  note: API.Note = new API.Note(this);
  /**
   ...
   */
  opportunity: API.Opportunity = new API.Opportunity(this);
  /**
   ...
   */
  workflowRun: API.WorkflowRun = new API.WorkflowRun(this);
  /**
...
export declare namespace Lightfield {
  ...
  export {
    ...
    type ContactDefinitionsResponse as ContactDefinitionsResponse,
  ...
  export {
    ...
    type MeetingUpdateResponse as MeetingUpdateResponse,
  ...
  export {
    File as File,
    type FileCancelResponse as FileCancelResponse,
    type FileCompleteResponse as FileCompleteResponse,
    type FileCreateResponse as FileCreateResponse,
    type FileListResponse as FileListResponse,
    type FileRetrieveResponse as FileRetrieveResponse,
    type FileURLResponse as FileURLResponse,
    type FileCreateParams as FileCreateParams,
    type FileListParams as FileListParams,
    type FileCancelParams as FileCancelParams,
