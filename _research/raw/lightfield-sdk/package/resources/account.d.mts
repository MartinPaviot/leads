...
export interface AccountCreateResponse {
     ...
     */
    fields: {
        [key: string]: AccountCreateResponse.Fields;
    };
    /**
     ...
     */
    relationships: {
        [key: string]: AccountCreateResponse.Relationships;
    };
    /**
...
export declare namespace AccountCreateResponse {
    interface Fields {
        /**
...
export interface AccountDefinitionsResponse {
     ...
     */
    fieldDefinitions: {
        [key: string]: AccountDefinitionsResponse.FieldDefinitions;
    };
    /**
    ...
    relationshipDefinitions: {
        [key: string]: AccountDefinitionsResponse.RelationshipDefinitions;
    };
}
export declare namespace AccountDefinitionsResponse {
...
export interface AccountRetrieveResponse {
     ...
     */
    fields: {
        [key: string]: AccountRetrieveResponse.Fields;
    };
    /**
     * URL to view the entity in the Lightfield web app, or null.
     */
     ...
     */
    relationships: {
        [key: string]: AccountRetrieveResponse.Relationships;
    };
    /**
     * ISO 8601 timestamp of when the entity was last updated, or null.
     */
...
export declare namespace AccountRetrieveResponse {
    interface Fields {
        /**
         * The field value, or null if unset.
         */
...
export interface AccountUpdateResponse {
     ...
     */
    fields: {
        [key: string]: AccountUpdateResponse.Fields;
    };
    /**
     * URL to view the entity in the Lightfield web app, or null.
     */
     ...
     */
    relationships: {
        [key: string]: AccountUpdateResponse.Relationships;
    };
    /**
     * ISO 8601 timestamp of when the entity was last updated, or null.
     */
...
export interface AccountCreateParams {
     ...
     */
    fields: {
        [key: string]: string | number | boolean | Array<string> | AccountCreateParams.Address | AccountCreateParams.FullName | null;
    };
    /**
...
export interface AccountUpdateParams {
     ...
     */
    fields?: {
        [key: string]: string | number | boolean | Array<string> | AccountUpdateParams.Address | AccountUpdateParams.FullName | null;
    };
    /**
     ...
     */
    relationships?: {
        [key: string]: AccountUpdateParams.Relationships;
    };
}
