...
class File extends resource_1.APIResource {
     ...
     */
    retrieve(id, options) {
        return this._client.get((0, path_1.path) `/v1/files/${id}`, options);
    }
    /**
    ...
    cancel(id, params = undefined, options) {
        const { body } = params ?? {};
        return this._client.post((0, path_1.path) `/v1/files/${id}/cancel`, { body: body, ...options });
    }
    /**
    ...
    complete(id, body, options) {
        return this._client.post((0, path_1.path) `/v1/files/${id}/complete`, { body, ...options });
    }
    /**
     ...
     */
    url(id, options) {
        return this._client.get((0, path_1.path) `/v1/files/${id}/url`, options);
    }
}
exports.File = File;
