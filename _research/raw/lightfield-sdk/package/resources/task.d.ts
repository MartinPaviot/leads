...
export interface TaskCreateResponse {
     ...
     */
    fields: {
        [key: string]: TaskCreateResponse.Fields;
    };
    /**
     ...
     */
    relationships: {
        [key: string]: TaskCreateResponse.Relationships;
    };
    /**
...
export interface TaskDefinitionsResponse {
     ...
     */
    fieldDefinitions: {
        [key: string]: TaskDefinitionsResponse.FieldDefinitions;
    };
    /**
    ...
    relationshipDefinitions: {
        [key: string]: TaskDefinitionsResponse.RelationshipDefinitions;
    };
}
export declare namespace TaskDefinitionsResponse {
...
export interface TaskRetrieveResponse {
     ...
     */
    fields: {
        [key: string]: TaskRetrieveResponse.Fields;
    };
    /**
     * URL to view the entity in the Lightfield web app, or null.
     */
     ...
     */
    relationships: {
        [key: string]: TaskRetrieveResponse.Relationships;
    };
    /**
     * ISO 8601 timestamp of when the entity was last updated, or null.
     */
...
export interface TaskUpdateResponse {
     ...
     */
    fields: {
        [key: string]: TaskUpdateResponse.Fields;
    };
    /**
     * URL to view the entity in the Lightfield web app, or null.
     */
     ...
     */
    relationships: {
        [key: string]: TaskUpdateResponse.Relationships;
    };
    /**
     * ISO 8601 timestamp of when the entity was last updated, or null.
     */
...
export declare namespace TaskUpdateResponse {
    interface Fields {
        /**
         * The field value, or null if unset.
         */
...
export interface TaskUpdateParams {
     ...
     */
    relationships?: {
        [key: string]: TaskUpdateParams.Relationships;
    };
}
