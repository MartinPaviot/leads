 ...
 */
class Meeting extends resource_1.APIResource {
    /**
     ...
     */
    retrieve(id, options) {
        return this._client.get((0, path_1.path) `/v1/meetings/${id}`, options);
    }
    /**
    ...
    update(id, body, options) {
        return this._client.post((0, path_1.path) `/v1/meetings/${id}`, { body, ...options });
    }
    /**
